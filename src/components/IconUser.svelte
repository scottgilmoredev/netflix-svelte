<script lang="ts">
  ...
  /**
   * Props for the IconUser component
   *
   * @typedef {Object} IconUserProps
  ...
  export let width: IconUserProps['width'] = '24';
  export let height: IconUserProps['height'] = '24';
  export let className: IconUserProps['className'] = '';
</script>
