<script lang="ts">
  /**
   * IconCircleQuestionMark Component
   *
   * @component
   * @description A question mark in a circle icon for help or information
   *
  ...
  /**
   * Props for the IconCircleQuestionMark component
   *
   * @typedef {Object} IconCircleQuestionMarkProps
   ...
   */
  interface IconCircleQuestionMarkProps {
    width?: string;
    height?: string;
    className?: string;
  }

  export let width: IconCircleQuestionMarkProps['width'] = '24';
  export let height: IconCircleQuestionMarkProps['height'] = '24';
  export let className: IconCircleQuestionMarkProps['className'] = '';
</script>
