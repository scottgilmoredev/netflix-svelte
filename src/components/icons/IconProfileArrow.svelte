<script lang="ts">
  /**
   * IconProfileArrow Component
   *
   * @component
   * @description A profile with arrow icon
   *
  ...
  /**
   * Props for the IconProfileArrow component
   *
   * @typedef {Object} IconProfileArrowProps
   ...
   */
  interface IconProfileArrowProps {
    width?: string;
    height?: string;
    className?: string;
  }

  export let width: IconProfileArrowProps['width'] = '24';
  export let height: IconProfileArrowProps['height'] = '24';
  export let className: IconProfileArrowProps['className'] = '';
</script>
