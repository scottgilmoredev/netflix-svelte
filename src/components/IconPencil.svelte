<script lang="ts">
  /**
   * IconPencil Component
   *
   * @component
   * @description A pencil icon used for editing
   *
  ...
  /**
   * Props for the IconPencil component
   *
   * @typedef {Object} IconPencilProps
  ...
  export let width: IconPencilProps['width'] = '24';
  export let height: IconPencilProps['height'] = '24';
  export let className: IconPencilProps['className'] = '';
</script>
